...
function NewContent () {
    return (
        <div className="new-content">
            ...
            <div className="new-content__articles-container">
                <div className="new-content__article">
                    <a href=""><h4 className="new-content__article-header">Hydrogen VS Electric Cars</h4></a>
                    <p className="new-content__article-text">Will hydrogen fueled cars ever catch up to EVs?</p>
                </div>
                <hr />

                <div className="new-content__article">
                    <a href=""><h4 className="new-content__article-header">The downsides of AI Artistry</h4></a>
                    <p className="new-content__article-text">What are the possible adverse effects of on-demand AI image generation?</p>
                </div>
                <hr />
                
                <div className="new-content__article">
                    <a href=""><h4 className="new-content__article-header">Is VC Funding Drying Up?</h4></a>
